...
namespace DraconiusGoGUI.Extensions
{
    ...
    public class ConsoleHelper
    {
        ...
        // Find window by Caption 2 
        public IntPtr FindWindowByCaption(string windowName)
        {
            var hWnd = NativeMethods.FindWindowByCaption(IntPtr.Zero, windowName);
            return hWnd;
        }
